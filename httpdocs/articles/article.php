...
?>      
    ...
    <title><?php echo $_SESSION['content_array'][$id_now]['page_title'];?>|Article|</title>
            ...
            <div id="banner-article">
                <div id="left-article">
                  <div id="right-article">
                    <?php //Video for Odd numbers, Article for Even Numbers...
					...
					//echo 'id = '.$id.' => content_type = '.$record['content_type'].' => record count - '.$content_counter.'</p>';	
						...
						{				
							...
							<div class="right-vid-wrapper">
								<div class="right-vid-icon"> <a href="/videos/video.php?id='.$_SESSION['content_array'][$id]['id'].'&tag='.$_SESSION['content_array'][$id]['page_field1'].'"><img src="../images/cms/'.$id.'/'.$_SESSION['content_array'][$id]['page_img_large'].'" width="120" height="120" alt="'.$_SESSION['content_array'][$id]['page_field1'].'" /></a>
							</div>
							
								<div class="right-vid-text">
									<h4 class="bluevid"><a href="/videos/video.php?id='.$_SESSION['content_array'][$id]['id'].'&tag='.$_SESSION['content_array'][$id]['page_field1'].'">'.$_SESSION['content_array'][$id]['page_title'].'</a></h4>
									<span class="black">'.$_SESSION['content_array'][$id]['page_desc'].'</span>
									<h5 class="bluevid"><a href="/videos/video.php?id='.$_SESSION['content_array'][$id]['id'].'&tag='.$_SESSION['content_array'][$id]['page_field1'].'" >Watch Video</a></h5>
								</div>
							</div>
							';
							$count_toggler = 1;
